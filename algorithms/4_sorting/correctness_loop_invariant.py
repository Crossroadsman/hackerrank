...
algorithms. You can see [these][http://www.cs.uofs.edu/~mccloske/courses/cmps144/invariants_lec.html] 
...
Details 
-------
The Input format and the constraints are the same as in the previous challenges 
